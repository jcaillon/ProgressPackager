...
namespace csdeployer.Core.Deploy {
    ...
    public class FileToDeploy {
        ...
        /// </summary>
        protected virtual string DeployImage {
            get { return Utils.GetExtensionImage((Path.GetExtension(To) ?? "").Replace(".", "")); }
        }
    ...
    internal class FileToDeployDeleteFolder : FileToDeploy {
        ...
        /// The image that should be used for this deployment representation
        /// </summary>
        protected override string DeployImage {
            get { return Utils.GetExtensionImage("Folder", true); }
        }
    ...
    internal class FileToDeployDeleteInProlib : FileToDeployInPack {
        ...
        /// </summary>
        protected override string DeployImage {
            get { return Utils.GetExtensionImage("Pl", true); }
        }
