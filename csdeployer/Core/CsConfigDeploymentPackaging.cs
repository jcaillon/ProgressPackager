...
namespace csdeployer.Core {
    ...
    internal class CsConfigDeploymentPackaging : ConfigDeploymentPackaging{

        private static CsConfigDeploymentPackaging _config;

        /// <summary>
        ///     Return the current ProgressEnvironnement object (null if the list is empty!)
        /// </summary>
        internal static CsConfigDeploymentPackaging Instance {
            get {
                if (_config == null)
                    _config = new CsConfigDeploymentPackaging();
                return _config;
            }
            set { _config = value; }
        }
