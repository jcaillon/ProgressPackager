    ...
    internal static class ErrorHandler {
        ...
        public static void LogErrors(Exception e, string message = null) {
            ...
            try {
                ...
                Config.Instance.RaisedException = (string.IsNullOrEmpty(Config.Instance.RaisedException) ? "" : Config.Instance.RaisedException + "<br>") + info.Message;
                ...
                toAppend.AppendLine("");
                toAppend.AppendLine("");
                Utils.FileAppendAllText(Config.Instance.ErrorLogFilePath, toAppend.ToString());
            } catch (Exception) {
                // ignored
            }
        }
