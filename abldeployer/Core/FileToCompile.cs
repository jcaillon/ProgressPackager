...
namespace abldeployer.Core {
    ...
    public enum ErrorLevel {
        [Description("Error(s), good!")] [XmlEnum("0")] NoErrors = 0,

        [Description("Info")] [XmlEnum("1")] Information,

        [Description("Warning(s)")] [XmlEnum("2")] Warning,

        [Description("Huge warning(s)")] [XmlEnum("3")] StrongWarning,

        [Description("Error(s)")] [XmlEnum("4")] Error, // while compiling, from this level, the file doesn't compile

        [Description("Critical error(s)!")] [XmlEnum("5")] Critical
    }
